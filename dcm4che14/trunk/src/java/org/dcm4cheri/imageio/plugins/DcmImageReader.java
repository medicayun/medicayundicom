 ...
 * @version $Revision: 18680 $ $Date: 2017-01-24 16:59:52 +0800 (周二, 24 1月 2017) $
 */
public class DcmImageReader extends ImageReader {
    ...
    private void readMetadata() throws IOException {
        ...
        int alloc;
        alloc = theDataset.getInt(Tags.BitsAllocated, 8);        
        if (theParser.getReadTag() != Tags.PixelData || alloc == 32 || alloc == 1) {
