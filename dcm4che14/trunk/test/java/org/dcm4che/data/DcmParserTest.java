...
public class DcmParserTest extends TestCase {
    ...
    private static final String PRV_TAG_FRAGMENT_EVR_LE = "data/private_tag_fragment";
    ...
    public void testPRV_TAG_FRAGMENT_EVR_LE() throws Exception {
        DataInputStream in = new DataInputStream(
                new BufferedInputStream(new FileInputStream(PRV_TAG_FRAGMENT_EVR_LE)));
        try {
            parser = pfact.newDcmParser(in);
            parser.parseDcmFile(null, -1);
        } finally {
