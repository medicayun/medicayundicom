 ...
 * @version $Revision: 18391 $ $Date: 2014-11-13 21:10:00 +0800 (周四, 13 11月 2014) $
 * @since Jan 16, 2006
 */
public abstract class AbstractFileCopyService extends ServiceMBeanSupport
    ...
    private boolean disableSeriesStored;
    ...
    public boolean isSeriesStoredDisabled() {
        return disableSeriesStored;
    }

    public void setSeriesStoredDisabled(boolean b) {
        this.disableSeriesStored = b;
    }
    ...
    public void handleNotification(Notification notif, Object handback) {
        if (disableSeriesStored) {
            log.debug("Handle SeriesStored notification is disabled!");
            return;
        }
        if (destination == null) {
            log.debug("Destination is not configured! Skip SeriesStored notification!");
            return;
        }
