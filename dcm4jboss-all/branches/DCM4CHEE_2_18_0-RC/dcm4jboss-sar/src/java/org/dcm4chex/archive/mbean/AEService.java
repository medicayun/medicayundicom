 ...
 * @since July 24, 2002
 * @version $Revision: 18358 $ $Date: 2014-09-30 22:50:00 +0800 (周二, 30 9月 2014) $
 */
public class AEService extends ServiceMBeanSupport {
	...
	protected void checkAETitle(String aeTitle){
	    int pos = aeTitle.indexOf('^');
	    if (pos == -1) {
		StringUtils.checkAET(aeTitle);
	    } else {
                StringUtils.checkAET(aeTitle.substring(0, pos));
                StringUtils.checkAET(aeTitle.substring(++pos));
	    }
	}
