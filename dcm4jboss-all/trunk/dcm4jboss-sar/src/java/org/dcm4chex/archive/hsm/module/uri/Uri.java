...
public class Uri {
    ...
    protected static void copyTo(String src, String dstUrl, String dst, String identity, long retention, boolean setAccessTimeAfterSetReadonly, String cifsRetentionTimes) throws Exception {
        switch (isUri(dstUrl)) {
        case SSH:
        ...
        case SFTP:
            ...
            break;
        case CIFS:
            Cifs.copyTo(src, dstUrl + "/" + dst, retention, setAccessTimeAfterSetReadonly, cifsRetentionTimes);
            break;
        default:
