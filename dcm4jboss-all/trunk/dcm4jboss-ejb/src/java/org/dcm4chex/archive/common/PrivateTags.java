 ...
 * @version $Revision: 18658 $ $Date: 2016-10-12 21:17:13 +0800 (周三, 12 10月 2016) $
 * @since 06.10.2004
 *
 */
public class PrivateTags {
    ...
    public static String getStringValue(Dataset ds, int privTag) {
        ds.setPrivateCreatorID(PrivateTags.CreatorID);
        ByteBuffer bb = ds.getByteBuffer(privTag);
