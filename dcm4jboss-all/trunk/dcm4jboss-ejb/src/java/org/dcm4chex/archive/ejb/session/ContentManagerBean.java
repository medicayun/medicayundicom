 ...
 * @version $Revision: 18569 $ $Date: 2016-04-26 22:50:48 +0800 (周二, 26 4月 2016) $
 * @since 14.01.2004
 * 
    ...
    public Collection getSOPInstanceRefMacros( Collection instanceUIDs ) throws FinderException {
    	...
    	for ( Iterator iter = instanceUIDs.iterator() ; iter.hasNext() ; ) {
        	...
        	if ( refSopSq == null ) {
    			...
    			serDS.putSH( Tags.StorageMediaFileSetID, series.getFilesetId() );
    			serDS.putUI( Tags.StorageMediaFileSetUID, series.getFilesetIuid() );
